...
import com.xyys.memorytext.Engine.CommonInfoEngine;
import com.xyys.memorytext.R;
import com.xyys.memorytext.bean.ShoppingCart;
import com.xyys.memorytext.bean.Ticket;
...
import com.xyys.memorytext.view.adapter.PoolAdapter;
import com.xyys.memorytext.view.custom.MyGridView;
import com.xyys.memorytext.view.manager.BaseUI;
import com.xyys.memorytext.view.manager.BottomManager;
import com.xyys.memorytext.view.manager.MiddleManager;
import com.xyys.memorytext.view.manager.PlayGame;
import com.xyys.memorytext.view.manager.TitleManager;
import com.xyys.memorytext.view.sensor.ShakeListener;
...
public class PlaySSQ extends BaseUI implements PlayGame {
	...
	@Override
	public void init() {
		//这里错误 一般是 R.layout.il_playssq 资源文件中 错误
